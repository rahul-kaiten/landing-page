...
@section('comm')
            ...
            <div id="main-wrapper" class="page-wrapper">
                        ...
                        <div class="row justify-content-center text-center">
                            <div class="col-lg-7 col-md-12">
                                <div class="heading-wrapper wow fadeInDown" data-wow-delay="0.8s">
                                    ...
                                    <div class="lead-text">
                                        <p>Integrated CRM, project management, time tracking and billing for freelancers, consultants and teams.</p>    
                                    </div>
                                </div>
                ...
                <div class="about-section section-padding dc-two">
                    <div class="container">
                        <div class="row clearfix align-items-center flex-row-reverse justify-content-between">
                            <div class="col-lg-6">
                                <div class="video-wrapper">
                                    <div class="video-player">
                                        <iframe width="560" height="315" src="https://www.youtube.com/embed/I7CfaDYzTVM" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div><!-- End Col -->
                            <div class="col-lg-5">
                                <div class="heading-wrapper with-separator">
                                    <h2 class="h1">Manage all your work from <span>One Place</span></h2>
                                </div>
                                <!-- End Heading -->
                        ...
                        <div class="row clearfix justify-content-center">
                            <div class="col-lg-10">
                                <div class="heading-wrapper text-center with-separator">
                                    <h2 class="h1">Focus on <span>getting things</span> done with DCode</h2>
                                    <div class="lead-text">
                ...
                <!-- Services Section -->
                <div class="features-section section-padding style-dark dark-bg gradient-heading-bg dc-two">
                    <div class="container">
                        <div class="row justify-content-center clearfix">
                            <div class="col-lg-8">
                                <div class="heading-wrapper text-center">
                                    <h2 class="h1">We offer Powerfull <span>features</span></h2>
                                    <div class="lead-text">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis finibus mi id elit gravida, quis tincidunt purus fringilla. Aenean convallis a neque non pellentesque.</p>
                                    </div>
                                </div><!-- End Heading -->
                                ...
                                <div class="price-card text-center wow fadeInLeft">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="pricing-feature-list">
                                            ...
                                            <li class="disabled">Reports & Billing</li>
                                            <li>100Mb Storage</li>
                                        </ul>
                ...
                <!-- Testimonial Section -->
                <div class="subscribe-section section-padding pt-0">
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="heading-wrapper with-separator">
                                    <h2 class="h1">Subscribe to our <span>Newsletter</span></h2>
                                    <div class="lead-text">
                                ...
                                <div class="subscribe-form-wrapper">
                                    <form method="post">
                                        <div class="form-group">
                                            <input type="email" name="EmailInput" class="form-control" placeholder="Enter Your Email" required="">
                                        </div>
